...
export const generateMetadata = async (
  ...
  await prisma.storyMetadata
    .create({
      data: {
        storyName: (response.StoryName as string) || "Untitled Story",
...
export const generateChapter = async (
  ...
  try {
    ...
    const metadata = await prisma.storyMetadata.findUnique({
      where: { id: id },
    });
    ...
    // Check if the user is the owner of the metadata  #HIMATODO: Add user own this check
